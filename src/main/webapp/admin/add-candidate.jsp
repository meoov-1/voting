...
<div class="admin-main">
    <header class="admin-topbar glass">
        <div class="topbar-left">
            ...
            <h1 class="topbar-title">Add Candidate</h1>
        </div>
    ...
    <div class="admin-content">
        ...
        <div class="form-card glass">
            <h2 class="form-card-title">New Candidate</h2>
            <form action="${pageContext.request.contextPath}/admin/candidates" method="post" enctype="multipart/form-data" class="admin-form">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" name="name" class="form-input" placeholder="e.g. Jane Smith" required>
                    </div>
                    <div class="form-group">
                        <label class="form-label">Position / Role <span class="required">*</span></label>
                        <input type="text" name="position" class="form-input" placeholder="e.g. President" required>
                    </div>
                </div>

                <div class="form-group">
                    <label class="form-label">Bio / Description</label>
                    <textarea name="bio" class="form-textarea" rows="4" placeholder="Brief description about the candidate..."></textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="file-upload-area" id="uploadArea" onclick="document.getElementById('imageInput').click()">
                        <div class="file-upload-preview" id="previewWrap" style="display:none;">
